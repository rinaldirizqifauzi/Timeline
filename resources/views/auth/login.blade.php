        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="flex item-center justify-between mt-4">
                <label for="remember_me" class="inline-flex items-center">
                    <input id="remember_me" type="checkbox" class="rounded border-gray-300 text-blue-600 focus:border-blue-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" name="remember">
